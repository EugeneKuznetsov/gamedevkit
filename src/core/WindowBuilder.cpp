...
WindowBuilder::WindowBuilder(const std::string& title, const windows::WindowSize& resolution)
    : title_{title}
    , resolution_{std::make_unique<windows::WindowSize>(resolution)}
    , window_hints_{std::make_unique<glfwcxx::WindowHints>()}
{
}
...
auto WindowBuilder::build(const std::string& title, const windows::WindowSize& resolution) -> std::unique_ptr<Window>
{
...
auto WindowBuilder::resolution(const windows::WindowSize& resolution) -> WindowBuilder&
{
    resolution_ = std::make_unique<windows::WindowSize>(resolution);
    return *this;
}
