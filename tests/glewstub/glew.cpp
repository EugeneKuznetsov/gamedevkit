...
{
    gamedevkit::GlewStub::gl_create_program_call_count_++;
    return gamedevkit::GlewStub::gl_create_program_return_value_;
}

extern auto glDeleteProgram(GLuint /*program*/) -> void
{
    gamedevkit::GlewStub::gl_delete_program_call_count_++;
}
...
{
    *params = gamedevkit::GlewStub::gl_get_program_iv_set_success_ ? 1 : 0;
}
...
GLuint GlewStub::gl_create_program_return_value_ = 1u;
int GlewStub::gl_create_shader_call_count_ = 0;
int GlewStub::gl_delete_shader_call_count_ = 0;
int GlewStub::gl_create_program_call_count_ = 0;
int GlewStub::gl_delete_program_call_count_ = 0;
bool GlewStub::gl_get_shader_iv_set_success_ = true;
bool GlewStub::gl_get_program_iv_set_success_ = true;
...
auto GlewStub::reset() -> void
{
    ...
    gl_create_program_return_value_ = 1u;
    gl_create_shader_call_count_ = 0;
    gl_delete_shader_call_count_ = 0;
    gl_create_program_call_count_ = 0;
    gl_delete_program_call_count_ = 0;
    gl_get_shader_iv_set_success_ = true;
    gl_get_program_iv_set_success_ = true;
}
...
auto GlewStub::gl_create_program_return_value(GLuint value) -> void
{
    gl_create_program_return_value_ = value;
}
...
auto GlewStub::gl_get_program_iv_set_success(bool success) -> void
{
    gl_get_program_iv_set_success_ = success;
}
...
{
    return gl_create_program_call_count_;
}

auto GlewStub::gl_delete_program_call_count() -> int
{
    return gl_delete_program_call_count_;
}
